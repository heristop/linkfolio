...
export const avatarCardAlt = userConfig.fullName ?? "Linkfolio";
...
/**
 * The person-branded Open Graph card: avatar, name, alias, description.
 * Shared between the root route (profile mode) and /demo (showcase mode) so
 * the two never drift apart.
 */
export function avatarCard(): ImageResponse {
